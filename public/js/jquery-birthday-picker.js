    ...
    generateBirthdayPicker = function ($parent, options) 
    {
        ...
        // Create the html picker skeleton
          var $fieldset = $("<fieldset class='birthdayPicker'></fieldset>"),
            $year = $("<select class='birthYear "+options.sizeClass+"' name='year'></select>"),
              $month = $("<select class='birthMonth "+options.sizeClass+"' name='month'></select>"),
              $day = $("<select class='birthDate "+options.sizeClass+"' name='day'></select>")
